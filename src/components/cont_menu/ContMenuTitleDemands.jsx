...
export const ContMenuTitleDemands = ({ isOpen, onClick }) => {
  return (
    <div 
    ...
    >
      <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
        <span className="material-symbols-rounded icon--md">manage_search</span>
        <p className="paragraph--mid--2"><b>Menú de demandas</b></p>
      </div>
