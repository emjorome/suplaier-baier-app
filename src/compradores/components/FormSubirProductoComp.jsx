...
export const FormSubirProductoComp = () => {
  ...
  const validarTodosCampos = () => {
    return new Promise((resolve, reject) => {
      ...
      if (
        regexNombreProducto.test(nombreProducto) &&
  ...
  const onContinuarSubirProducto = (e) => {
    ...
    validarTodosCampos()
      ...
      .catch((res) => console.log("Producto no válido"));
  };
    ...
    <form onSubmit={onContinuarSubirProducto}>
      <div className="compraProducto__box">
        ...
        <div className="formSubirProducto u-margin-top-small">
          <label
            align="right"
            htmlFor="formSubirProdDescripcion"
            className="paragraph--smResp paragraph--bold formSubirProducto__label"
          >
            Descripción
          </label>
          <div className="formSubirProducto__inputBox">
            ...
            {!esDescripcionValido && (
              <p className="paragraph--red u-padding-left-small">
                Descripción no válida, , no caracteres especiales excepto -_,.
                mínimo 5 máximo 480 caracteres
              </p>
            )}
          </div>
        </div>
        <div className="formSubirProducto u-margin-top-small">
          <label
            align="right"
            htmlFor="formSubirProdCategoria"
            className="paragraph--smResp paragraph--bold formSubirProducto__label"
          >
            Categoría
          </label>
          <div className="formSubirProducto__inputBox">
            <select
              ...
              onChange={onInputChange}
            >
              <option defaultValue={"none"}>Seleccionar categoría</option>
              {categorias?.map((cat) => (
          ...
          <div className="formSubirProducto u-margin-top-small">
            ...
            <div className="formSubirProducto__imgBox">
              ...
              <img
                src={imagen}
                alt={urlImg}
                className="formSubirProducto__imgBox__img"
              />
            </div>
          </div>
        )}
      ...
      <div>
        ...
        {showAccionErronea && (
          <AccionExitosa
            texto={
              "Hubo un error al intentar subir el producto, verifique que el tamaño de la imagen no supere los 50kb"
            }
            showAccionErronea={showAccionErronea}
            setShowAccionExitosa={setShowAccionExitosa}
            setShowAccionErronea={setShowAccionErronea}
